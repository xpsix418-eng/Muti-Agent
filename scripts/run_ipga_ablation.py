...
EXPERIMENTS = [
    ...
    {
        "name": "IPG-MAPPO + Assignment Gate",
        "policy": "ipga_mappo",
    ...
    },
    {
        "name": "IPG-MAPPO",
        "policy": "ipga_mappo",
        "config": "configs/train_ipg_mappo_5v5.yaml",
        "checkpoint": "experiments/results/ipga_ablation/no_assignment_gate/Scenario5v5/checkpoints/latest.pt",
        "train": ["scripts/train_ipga_mappo.py", "--config", "configs/train_ipg_mappo_5v5.yaml"],
    },
    {
        "name": "IPG-MAPPO without graph",
        "policy": "ipga_mappo",
    ...
    {
        "name": "IPG-MAPPO + Assignment Gate without assignment auxiliary loss",
        "policy": "ipga_mappo",
